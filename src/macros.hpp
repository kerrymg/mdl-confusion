...
mdl_value_t *mdl_additem(mdl_value_t *a, mdl_value_t *b, mdl_value_t **lastitem = nullptr);
...
mdl_value_t *mdl_eval(mdl_value_t *l, bool in_struct = false, mdl_value_t *environment = nullptr);
